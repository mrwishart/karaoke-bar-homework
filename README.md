# OOP, TDD and Multiclass Weekend Homework

Week 2, Weekend homework at CodeClan. Enforced use of OOP w/ multiple classes and TDD to create a karaoke system from scratch.
